...
<body>
    ...
    if (v >= p && v >= k)
    {out.println("<body style='background-color:#D7E2E8;'></body>"
    ...
    {
    out.println("<center><h1>Your dominant dosha is identified as “Pitta” (Fire & Little Water).<br><i>Spicy food? Yes, please! I can handle the heat</i></h1></center><br><h2>Pitta Dosha Health Complications</h2>"
    + "<br><br>"
    + "<ul>"
    ...
    {
    out.println("<center><h1>Your dominant dosha is identified as “Kapha” (Earth & Water).<br><i>I need my beauty sleep. Eight hours minimum, please!</i></h1></center><br><h2>Kapha Dosha Health Complications</i></h2>"
    + "<br><br>"
    + "<ul>"
